    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3 text-sm">
        <div className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4">
          <div className="text-xs text-red-300">Честная игра</div>
          <p className="mt-2 text-xs text-slate-400">
            Провайдеры с лицензией, прозрачные RTP и понятные условия.
          </p>
        </div>
        <div className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4">
          <div className="text-xs text-red-300">Ответственная игра</div>
          <p className="mt-2 text-xs text-slate-400">
            Лимиты и инструменты контроля.
          </p>
        </div>
        <div className="rounded-2xl border border-slate-800 bg-slate-950/80 p-4">
          <div className="text-xs text-red-300">Скорость</div>
          <p className="mt-2 text-xs text-slate-400">
