...
CREATE TABLE "Tournament" (
  ...
  "slug" TEXT NOT NULL,
  "name" TEXT NOT NULL,
  "type" "TournamentType" NOT NULL DEFAULT 'DAILY_SPRINT',
...
-- CreateIndex
CREATE INDEX "TournamentEntry_userId_lastRoundAt_idx" ON "TournamentEntry"("userId", "lastRoundAt");
...
-- AddForeignKey
ALTER TABLE "TournamentRound" ADD CONSTRAINT "TournamentRound_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
